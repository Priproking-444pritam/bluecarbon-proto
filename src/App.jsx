    ...
    <div className="bg-white rounded shadow-sm border p-6">
      ...
      <div className="mt-4 flex justify-between">
        ...
        <div className="flex gap-2">
          ...
          <button onClick={() => { localStorage.removeItem(LS_KEY); setForm({ name: "", description: "", country: "", lat: "", long: "", ecosystem: "Mangroves", documents: [] }); }} className="px-3 py-2 bg-red-100 rounded">Clear Draft</button>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="w-72 bg-white border-r border-gray-200 h-screen sticky top-0">
      ...
      <nav className="p-4 space-y-1">
        {nav.map(n => (
          <div key={n.key} onClick={() => onSelect(n.key)} className={`flex items-center gap-3 p-3 rounded cursor-pointer ${active === n.key ? "bg-sky-50 border border-sky-100" : "hover:bg-gray-50"}`}>
      ...
      <div className="bg-white rounded shadow-sm border p-4">
        ...
        <div className="mt-4" style={{ height: "280px" }}>
          <Suspense fallback={<div className="h-48 flex items-center justify-center text-gray-400">Loading map…</div>}>
            <ProjectMap projects={sampleProjects} center={[5, 20]} zoom={2} />
          </Suspense>
        </div>
      </div>
    </div>
      ...
      <div className="bg-white rounded shadow-sm border p-4">
        ...
        <div className="mt-6 grid grid-cols-2 gap-6">
          ...
          <div className="bg-gray-50 p-4 rounded border">
            ...
            <div className="mt-2">GANACHE — Chain ID 1337</div>
            <div className="mt-4">
        ...
        <div className="mt-6">
          ...
          <div className="mt-2"><button onClick={() => { const addr = document.getElementById("contractAddrMain").value.trim(); doMint(addr); }} className="px-3 py-2 bg-sky-600 text-white rounded">Mint 10 BCC</button></div>
        </div>
      </div>
    </div>
  );
...
// Simple fallback component for verification
const SimpleVerificationWorkflow = () => {
  const sample = [
    {
      id: 1,
        ...
        <div className="flex-1 min-h-screen">
          ...
          <div className="p-6">
            ...
            <div className="bg-transparent min-h-[60vh] rounded">
              ...
              {route === "Verification" && <SimpleVerificationWorkflow />}
